...
<body>
  <nav class="top-nav">
    <a href="#" class="brand">
      <picture>
        ...
        <svg width="115px" height="40px" viewBox="-31.5 0 319 319" version="1.1" xmlns="http://www.w3.org/2000/svg"
  ...
  <div class="container">
        ...
        <details>
          <summary>
            ...
            <svg xmlns:inkscape="http://www.inkscape.org/namespaces/inkscape"
              ...
              sodipodi:docname="_svgclean2.svg" viewBox="0 0 218 122" version="1.1" inkscape:version="0.48.3.1 r9886">
              <sodipodi:namedview id="namedview8" bordercolor="#666666" inkscape:pageshadow="2" guidetolerance="10"
                pagecolor="#ffffff" gridtolerance="10" inkscape:window-maximized="0" inkscape:zoom="0.22425739"
                objecttolerance="10" borderopacity="1" inkscape:current-layer="svg2" inkscape:cx="372.04724"
                inkscape:cy="-404.18109" inkscape:window-y="0" inkscape:window-x="0" inkscape:window-width="640"
                showgrid="false" inkscape:pageopacity="0" inkscape:window-height="480" />
              <a href="sci-fi.php">
        ...
        <details>
          <summary>
            ...
            <svg xmlns:inkscape="http://www.inkscape.org/namespaces/inkscape"
              ...
              xmlns:ns1="http://sozi.baierouge.fr" xmlns:xlink="http://www.w3.org/1999/xlink" id="svg2986"
              sodipodi:docname="Taurus85.svg"
              inkscape:export-filename="D:\Dateien\rollenspiel\Welcome to ZED\Items\Taurus85.png"
              viewBox="0 0 431.81 290.32" inkscape:export-xdpi="300" version="1.1" inkscape:export-ydpi="300"
              ...
              <sodipodi:namedview id="base" fit-margin-left="0" inkscape:zoom="1.4" borderopacity="1.0"
                ...
                inkscape:document-units="mm" bordercolor="#666666" inkscape:window-x="-8" inkscape:window-y="-8"
                fit-margin-bottom="0" inkscape:window-width="1366" inkscape:pageopacity="0.0" inkscape:pageshadow="2"
                pagecolor="#ffffff" inkscape:window-height="706" fit-margin-top="0" />
              <a href="crime.php">
              <g id="layer1" inkscape:label="Layer 1" inkscape:groupmode="layer" transform="translate(-126.29 -141.21)">
    ...
    <main>
      ...
      <!-- Horror -->
      <div class="post">
        <a href="Horror1.php" target="_blank">
          <header>
          ...
          <div class="post-content">
            <h3>All the blue below</h3>
            <p>“Pardon?”

            <p>Maggie glanced over. “What?”</p>

            <p>“Could have sworn I just heard someone say my name…”...</p>
          </div>
        </a>
      </div>
      <!-- sci-fi -->
      <div class="post">
        <a href="sci-fi1.php" target="_blank">
          <header>
            <img src="./img/islabre-pfp.jpg" alt="" />
            <span>
              <b>LunaDreamer</b>
          ...
          <div class="post-content">
            <h3>K. and G.</h3>
            <p>It was summer, and the roses swam with scent. K. had tamed G. with intermittent kindness, as boys tame
              foxes to their hand, though she had been watchful and wary, knowing the violence of men...</p>
          </div>
        </a>
      </div>
      <!-- Romance --> 
      <div class="post">
        <a href="romance1.php" target="_blank">
          <header>
            <img src="./img/islabre-pfp.jpg" alt="" />
            <span>
              <b>PixelPioneer</b>
          ...
          <div class="post-content">
            ...
            <p>Aditi’s phone was ringing incessantly. It was her dad again. But she was in no mood to talk. Her parents
              were getting a divorce and she didn’t know...</p>
          </div>
        </a>
      </div>
      <!-- Crime -->
      <div class="post">
        <a href="Crime1.php">
          ...
          <div class="post-content">
            ...
            <p>It was on the 22nd of November. I was really excited because it was my best friend Aditi’s birthday the
              next day. I had planned a surprise party for her and I had to do all the preparations after coming...</p>
          </div>
        </a>
      </div>
      <!-- Fantasy --> 
      <div class="post">
        <a href="fantasy1.php">
          ...
          <div class="post-content">
            <h3>Playing God by Enzo</h3>
            <p>Screams filled the air.</p>
            <p>Tim woke in a sweat; his bed sheets were soaked through. Struggling for breath, he jumped out of bed
              and...</p>
          </div>
        </a>
      </div>
      ...
      <div class="post">
        <a href="Horror2.php">
          ...
          <div class="post-content">
            <h3>The one who mimics</h3>
            <p>He cried out for his mom, his small voice echoing across the endless cornfield. Mom always told him to
              stay put whenever he got lost, and she would go look for him. Being a spriteful...</p>
          </div>
        </a>
      </div>
      <!-- sci-fi 2nd -->
      <div class="post">
        <a href="sci-fi2.php">
          ...
          <div class="post-content">
            <h3>The Timekeeper's Dilemma</h3>
            <p>In the year 2157, humanity had harnessed the power to manipulate time. With this technology came great
              promise and peril. The Timekeepers, a group of elite scientists, were entrusted with the task of
              maintaining...</p>
          </div>
        </a>
      </div>
      ...
      <div class="post">
        <a href="romance2.php">
          ...
          <div class="post-content">
            ...
            <p>It was a rainy evening in the heart of the city. As people hurried past, seeking shelter from the
              downpour, two strangers found themselves standing beneath the same awning. Their eyes met for the briefest
              moment, and something magical...</p>
          </div>
        </a>
      </div>
      <!-- Non-fiction -->
      <div class="post">
        <a href="non-fiction1.php">
          <header>
            <img src="./img/islabre-pfp.jpg" alt="" />
            <span>
              <b>SilverFalcon</b>
      ...
      <div class="post">
        <a href="Crime2.php">
          ...
          <div class="post-content">
            <h3>The Stolen Heirloom</h3>
            <p>Detective Sarah Parker had seen it all during her years on the force, but the case of the stolen heirloom
              was about to test her skills to the limit.</p>
            <p>The Calloway mansion was known for its opulence, and it held a priceless family heirloom, the Calloway
              Diamond, a jewel...</p>
          </div>
        </a>
      </div>
      ...
      <div class="post">
        <a href="fantasy2.php">
          ...
          <div class="post-content">
            <h3>The Forgotten Enchantment</h3>
            <p>In the heart of the ancient forest, where emerald leaves whispered secrets, young Lila discovered a
              forgotten glade. In the center stood a mysterious oak tree with gnarled roots, its trunk adorned with
              glowing...</p>
          </div>
        </a>
      </div>
      ...
      <div class="post">
        <a href="non-fiction2.php">
          ...
          <div class="post-content">
            <h3>The Bicycle and the Life Lesson</h3>
            <p>When I was a child, my father gave me a bicycle for my birthday. It was a shiny, red, two-wheeled wonder
              that promised adventure and freedom. My excitement was boundless, and I ...</p>
          </div>
        </a>
      </div>
      <div class="post">
